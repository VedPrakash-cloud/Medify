...
export default function DownloadApp(){
    return (
        <div className='flex h-96 items-center justify-center bg-blue-50 p-10'>
            <img src={Mobile} alt="download.png" className='object-contain h-64 md:max-h-full w-min' />
            <div className='w-2/4 text-start font-poppins flex flex-col items-start justify-center'>
                <h1 className='text-2xl md:text-5xl font-semibold text-[#1B3C74]'>Download the</h1>
                <p className='mt-2 text-2xl md:text-5xl font-semibold text-[#1B3C74]'><span className='text-[#2AA7FF]'>Medify </span>App</p>
                <p className='my-3 text-sm font-semibold'>Get the link to download the app</p>
                <div className='flex flex-col md:flex-row w-full items-center gap-2'>
                    <div className='flex border rounded-xl w-full md:w-3/4'>
                ...
                <div className='flex flex-row gap-5 md:my-5 w-full md:w-4/5 justify-between text-sm md:text-xl items-center mt-2 md:mt-10'>
